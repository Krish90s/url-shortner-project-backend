...
router.post("/", async (req, res) => {
  ...
  const msg = {
    ...
    https://url-shortner-workflow.netlify.app.netlify.app/resetpassword/${user.resetToken}`,
    html: `<h1>Hello,</h1>
    <p>thanks for refistering on our site.</p>
    <p>Please click the link below to reset your password.</p>
    <a href="https://url-shortner-workflow.netlify.app.netlify.app/resetpassword/${user.resetToken}">Verify Your Account</a>`,
  };
